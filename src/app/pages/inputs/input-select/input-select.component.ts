...
export class InputSelectComponent implements OnInit {
    ...
    form!: FormGroup;
    phoneTypeArray: SelectInputType[] = [{ name: "Ev", value: 'home' }, { name: "İş", value: 'Work' }, { name: "Cep", value: 'mobile' }, { name: "Diğer", value: 'other' }];
    phonePlaceholder: string = 'tel';
    contact: any;
    ...
    ngOnInit(): void {
        ...
        this.contact =
        {
            ...
            "phone": [{ "type": "home", "data": "222222" }, { "type": "mobile", "data": "1" }, { "type": "other", "data": "4" }, { "type": "work", "data": "3" }],
            "notes": "not",
            "jobtitle": "\u00dcnvan\u0131",
            "company": "\u015eirketi",
            "id": "6485",
            "create_date": "1681827158000",
            "tag_names": []
        }
